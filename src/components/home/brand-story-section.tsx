      ...
      <Container className="grid gap-14 py-20 sm:py-28 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-24 lg:py-40">
        ...
        <Reveal>
          ...
          <div className="mt-10 grid gap-7 text-base leading-9 text-white/62 sm:grid-cols-2 sm:gap-10">
            <p>
              AVELIA از یک باور ساده شکل گرفته است: انتخاب لوازم آرایشی و
              مراقبتی نباید میان انبوهی از گزینه‌های نامطمئن گم شود.
            </p>
            <p>
              ما از میان محصولات آرایشی، مراقبت پوست و عطر، انتخاب‌هایی را کنار
              هم قرار می‌دهیم که اصالت، کیفیت و تجربه‌ی زیبایی بهتری می‌سازند.
            </p>
          </div>
          <a
            href="#trust"
